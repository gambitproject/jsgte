    ...
    MultiAction.prototype.onClick = function() {
        switch (GTE.MODE) {
            case GTE.MODES.ADD:
                ...
                var changes = new GTE.TREE.Changes(GTE.MODES.ADD, GTE.REDO.MULTIACTIONLINES, this);
            ...
            case GTE.MODES.DELETE:
                ...
                var changes = new GTE.TREE.Changes(GTE.MODES.DELETE, GTE.REDO.MULTIACTIONLINES, this);
                var allLeaves = true;
            ...
            case GTE.MODES.PLAYER_ASSIGNMENT:
                ...
                var changes = new GTE.TREE.Changes(GTE.MODES.PLAYER_ASSIGNMENT, GTE.REDO.MULTIACTIONLINES, this);
            ...
            case GTE.MODES.MERGE:
                ...
                var isetInLoop = null;
                var changes = new GTE.TREE.Changes(GTE.MODES.MERGE, GTE.REDO.MULTIACTIONLINES, this);
