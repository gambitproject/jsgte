GTE.TREE = (function(parentModule) {
    ...
    /**
     * Creates a new StrategyProfile. ADAPTATION OF Strategy
     * @class
     */
    function StrategyProfile(strategicUnits, payoffs) {
        this.strategicUnits = strategicUnits;  // array of strategic units of players present in this strategy
        this.payoffs = payoffs;
    }

    //StrategyProfile.prototype.findPayoff = function(node) {
        //if(node.isLeaf()) {
    ...
    StrategyProfile.prototype.findStrategyUnitIndexOfPlayer = function(player) {
    ...
    StrategyProfile.prototype.assignPartner = function(x, y) {
    ...
    parentModule.StrategyProfile = StrategyProfile;
