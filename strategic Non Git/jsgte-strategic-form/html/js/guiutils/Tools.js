GTE.UI = (function (parentModule) {
    ...
    */
    ...
    /**
    *  JAUME generic check mod
    */
    Tools.prototype.genericCheck = function() {
        for (var i = 0; i < GTE.tree.matrix.strategies.length; i++) {
            console.log(GTE.tree.matrix.strategies[i]);
           // console.log(GTE.TREE.Strategy(GTE.tree.matrix.strategies[i]).payoffs);
        }
